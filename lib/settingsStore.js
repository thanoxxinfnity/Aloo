...
export const DEFAULT_SETTINGS = {
  ...
  elbowBend: 11,
  fingerCurl: 12,
  // A small star burning in each palm. Size is in world METRES (she is auto-fit
  // to ~1.7m), so 0.035 is a golf ball — big enough to read on a phone, small
  // enough that the halo does not swallow her hands.
  handStars: true,
  handStarSize: 0.035,
  handStarBrightness: 1.0,
  ...
  bloomIntensity: 0.9,
  // Backdrop: 'galaxy' (generated, differentially rotating), 'model'
  // (space.glb, rotated rigidly) or 'stars' (starfield only).
  backdrop: 'galaxy',
  // 90k points is one draw call; the shader does the orbital work per-vertex.
  galaxyStars: 90000,
  galaxySpin: 0.9, // rad/s at the nucleus — the rim turns far slower
